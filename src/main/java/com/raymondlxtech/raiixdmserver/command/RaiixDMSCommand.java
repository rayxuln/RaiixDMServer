...
public abstract class RaiixDMSCommand{
    ...
    public void sendFeedback(Entity sender, Text msg)
    {
        if(sender != null)
            ...
            theMod.theMinecraftServer.getPlayerManager().broadcastChatMessage(msg, false);
    }
    ...
    public void sendFeedbackError(Entity sender, String msg){
        sendFeedback(sender, new TranslatableText(msg).setStyle(new Style().setColor(Formatting.RED)));
    }
}
